...
import {
    selectDiveMode,
    setDiveMode,
} from "@/lib/redux/slices/diveMode/diveModeSlice";
import MeetSelectionComponent from "./MeetSelectionComponent";
...
const StartingQuestionsComponent = () => {
    ...
    const diverMeetArray = [
        ...
        {
            meet: "Andover vs Blaine",
            location: "Northdale MS",
            date: "8/29/23",
        },
        {
            meet: "Andover vs Maple Grove",
            location: "Maple Grove MS",
            date: "8/31/23",
        },
        {
            meet: "Andover vs Armstrong",
            location: "Fred Moore",
            date: "9/7/23",
        },
        ...
        {
            meet: "Anoka vs Rogers",
            location: "VandenBerge MS",
            date: "9/21/23",
        },
        {
            meet: "Maroon and Gold Invite",
            location: "Jean K Freeman Aquatic Center",
            date: "9/23/23",
        },
        {
            meet: "Andover vs Elk River",
            location: "Fred Moore",
            date: "9/28/23",
        },
        {
            meet: "Andover vs Coon Rapids",
            location: "Fred Moore",
            date: "10/10/23",
        },
        ...
        {
            meet: "True Team State",
            location: "Jean K Freeman Aquatic Center",
            date: "10/21/23",
        },
        { meet: "JV Championship", location: "Northdale MS", date: "10/28/23" },
        {
            meet: "7AA Section Diving Prelim",
            location: "Northdale MS",
            date: "11/10/23",
        },
        {
            meet: "7AA Section Diving Finals",
            location: "Northdale MS",
            date: "11/11/23",
        },
        {
            meet: "State Diving Prelims",
            location: "Jean K Freeman Aquatic Center",
            date: "11/16/23",
        },
        {
            meet: "State Diving Finals",
            location: "Jean K Freeman Aquatic Center",
            date: "11/18/23",
        },
    ];
    ...
    const handleSubmit = () => {
        if (!meetInfoObject.location || !meetInfoObject.date || !meetInfoObject.meet) {
        ...
        const judgeArray = judgeArrayBuilder(
            numberOfDivers,
            totalRounds,
            numberOfJudges
        );
        const diverScoreArray = diverArrayBuilder(
            0,
            numberOfDivers,
            totalRounds
        );
        const diverCodesArray = diverArrayBuilder(
            "N/A",
            numberOfDivers,
            totalRounds
        );
        const diverDescriptionsArray = diverArrayBuilder(
            "N/A",
            numberOfDivers,
            totalRounds
        );
        const diverDifficultyArray = diverArrayBuilder(
            0,
            numberOfDivers,
            totalRounds
        );
    ...
    return (
        <div className="flex justify-center text-center flex-col py-4 items-center">
            <MeetSelectionComponent selectedMeet={selectedMeet} setSelectedMeet={setSelectedMeet} meetMessage={meetMessage}/>
            <div className="flex flex-row items-center justify-center text-center py-2">
                ...
                <div className="flex flex-row justify-start space-x-4 ml-4">
                    <label>
                        ...
                        ></input>
                        <span className="text-xl pl-1">3</span>
                    </label>
                    <label>
                        <input
                            className="radio"
                            ...
                            onChange={handleJudgeNumberChange}
                        ></input>
                        <span className="text-xl pl-1">5</span>
                    </label>
                    <label>
                        <input
                            className="radio"
                            ...
                            onChange={handleJudgeNumberChange}
                        ></input>
                        <span className="text-xl pl-1">7</span>
                    </label>
                    <p>{judgeMessage}</p>
                </div>
            </div>
                ...
                <div className="flex flex-row items-center justify-start space-x-4 ml-4">
                    <label>
                        <input
                            ...
                            name="diveNumber"
                            value={6}
                            onChange={handleTotalRounds}
                        ></input>
                        <span className="text-xl pl-1">6</span>
                    </label>
                    <label>
                        <input
                            className="radio"
                            ...
                            onChange={handleTotalRounds}
                        ></input>
                        <span className="text-xl pl-1">11</span>
                    </label>
                    <p>{roundMessage}</p>
                </div>
            </div>
            ...
            <div className="flex justify-center items-center text-center py-2">
                <h3 style={{ paddingRight: "0.5em" }}>
                    Approximately how many divers are diving today?
                </h3>
                <input
                    className="lg:w-10 w-3 text-center"
                    placeholder="0"
                    name="diverInput"
                    type="text"
                    onChange={handleNumberOfDivers}
                ></input>
                <p>{diverMessage}</p>
            </div>
            <div>
